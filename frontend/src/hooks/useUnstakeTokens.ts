...
export const useUnstakeTokens = () => {
  ...
  const { send: farmTokenStakingBalance, state: farmTokenStakingBalanceState } = useContractFunction(
    tokenFarmContract, "stakingBalance", { transactionName: "Query Staked Balance" }
  )
